...
GameApp::GameApp(HINSTANCE hInstance)
	: D3DApp(hInstance), m_DirLight(),
	m_IndexCount(),
	m_VSConstantBuffer(), m_PSConstantBuffer()
{
}
...
bool GameApp::InitEffect()
{
	...
	// 创建顶点着色器
	HR(CreateShaderFromFile(L"HLSL\\Cube_VS.cso", L"HLSL\\Cube_VS.hlsl", "main", "vs_5_0", blob.ReleaseAndGetAddressOf()));
	...
	// 创建像素着色器
	HR(CreateShaderFromFile(L"HLSL\\Cube_PS.cso", L"HLSL\\Cube_PS.hlsl", "main", "ps_5_0", blob.ReleaseAndGetAddressOf()));
...
bool GameApp::InitResource()
{
	// ******************
		// 初始化网格模型
		//
	auto meshData = Cube::CreateBox<VertexPosNormalColor>();
	ResetMesh(meshData);
...
bool GameApp::ResetMesh(const Cube::MeshData<VertexPosNormalColor>& meshData)
{
	// 释放旧资源
